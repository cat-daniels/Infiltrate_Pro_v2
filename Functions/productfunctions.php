    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            if (sessioncheck()==true) {
                ...
                echo '<button type="submit" name="addToCartBtn" id= "Navbtn"class="btn btn-secondary">Add to Cart</button>';
            } else {
                echo '<a href="../auth/login.php" class="btn btn-secondary">Log in to Add to Cart</a>';
            }
            echo '</form>';
