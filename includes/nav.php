  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      <li class="nav-item active">
        <a href="#"></a><button class="btn btn-success my-2 my-sm-0" id="NavButton">Infiltrate Help</button>
      </li>
      <li class="nav-item">
        <a href="#"></a><button class="btn btn-info my-2 my-sm-0" id="NavButton">Shop</button>
      </li>
      <li class="nav-item">
    ...
    <div class="cart-icon">
      ...
      <!--In order to get the correct path we put the mainpage in default so that it could be accessed by the default nav with ../ -->
